          ...
          <div className="bs-docs-featurette col-centered" id="learnmore">
            <div className="container col-centered">
              ...
              <div className="row col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-centered" style={{ marginBottom: '80px;'}}>
                <div className="col-sm-11 feature-panel col-centered">
                  <p className="lead">
                    Since launching the Blockstack website a little over two months ago, an incredible amount of attention and support has poured into this community from talented and passionate developers and enthusiasts from all over the world. Developers from companies and projects such as <a href="http://www.2way.io" target="_blank">2WAY.IO</a>, <a href="http://www.bitmarkets.org" target="_blank">Bitmarkets</a>, <a href="https://www.bitseed.org" target="_blank">Bitseed</a>, <a href="http://trychord.com" target="_blank">Chord</a>, <a href="http://www.creativework.info" target="_blank">creativework.info</a>, <a href="http://datt.co/" target="_blank">Datt</a>, <a href="https://fabric.fm/" target="_blank">Fabric</a>, <a href="http://www.mine.nyc" target="_blank">Mine</a>, <a href="https://nametiles.co/" target="_blank">Nametiles</a>, <a href="http://www.ob1.io" target="_blank">OB1</a>, <a href="http://www.okturtles.org" target="_blank">the okTurtles Foundation</a>, <a href="https://stampery.co/" target="_blank">Stampery</a>, <a href="https://www.tierion.com" target="_blank">Tierion</a>, and <a href="http://zeronet.io/" target="_blank">ZeroNet</a> have joined the Blockstack community and are already contributing code and ideas. We have started and continued important discussions both in the <a href="http://forum.blockstack.org" target="_blank">forum</a> and <a href="http://chat.blockstack.org" target="_blank">Slack</a> about the future of decentralized application development and the role Blockstack will play in this space going forward. Progress is being made and issues are being resolved. We are invite all who support our mission to join our community and contribute to Blockstack!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-centered">
              <div className="container-fluid col-sm-12 center-block">
                <div className="container col-sm-4 feature-panel feat-block">
                  <a href="http://chat.blockstack.org/" target="_blank">
                    <h3>Chat on Slack</h3>
                ...
                <div className="container col-sm-4 feature-panel feat-block">
                  <a href="https://forum.blockstack.org/" target="_blank">
