...
export const milestones = [
  {
    ...
    description: "Initiate an auth request to redirect the user from the app to the browser portal. The user will see the details of the sign-in request and either confirm or deny it. They will then bring their profile information with them."
  },
  {
    date: 'Q2 2017',
    title: 'App-specific encrypted storage',
    description: "Store new app data with the user and access app data already stored with the user. Data is encrypted and synced up to the cloud providers and/or self-hosted servers that each user has connected."
  },
  {
    date: 'Q2 2017',
    title: 'Signing and payment requests',
    description: "Initiate requests for users to sign files and send payments. The user will be redirected from the app to the browser portal, where they will see the details of the request and either confirm or deny it."
  },
  {
    date: 'Q2 2017',
    title: 'Notification inbox',
    description: "Create event-driven notifications that can be sent from one user to another user's inbox. Each user gets an API endpoint that allows users to receive short messages. These "
  },
  {
    date: 'Q3 2017',
    title: 'Multi-app data storage',
    description: "Store user data in collections that can be used across various apps. A collection can be any created around any data type, like photos, videos, notes and invoices."
  },
  {
    date: 'Q4 2017',
    title: 'Blockstack iOS App',
    description: "The Blockstack iOS app will bring the Blockstack app platform to iPhones."
  },
  {
    date: 'Q4 2017',
    title: 'Blockstack Android App',
    description: "The Blockstack iOS app will bring the Blockstack app platform to Android phones."
  },
  {
    date: 'Q4 2017',
    title: 'Address bar name lookups',
    description: "Type Blockstack domain names directly into your browser to visit Blockstack apps. Enter Blockstack usernames to view Blockstack profiles."
  },
  {
    date: 'Q1 2018',
    title: 'P2P Attestation',
    description: "Peer-to-peer attestation will allow users to collect verification from both their peers and trusted authorities. Apps will be able to access user identity verifications and benefit from a greater level of trust."
  },
  {
    date: 'Q1 2018',
    title: 'P2P App Packaging & Loading',
    description: "Apps are currently loaded over DNS and HTTPS but they can alternatively be loaded as a bundle and delivered by any peer. This is a more decentralized way to access the app that will ensure it can't disappear or be unpublished, ever."
  },
  {
    date: 'Q1 2018',
    title: 'Blockstack on Ethereum',
    description: "Blockstack is a multi-chain system and can operate on any blockchain. It currently operates on Bitcoin but will be ported to Ethereum in the future. New TLDs will be able to be created on the Ethereum blockchain."
  },
  {
    date: 'Q2 2018',
    title: 'Blockstack on Zcash',
    description: "Blockstack is a multi-chain system and can operate on any blockchain. It currently operates on Bitcoin but will be ported to Zcash in the future. New TLDs will be able to be created on the Zcash blockchain."
  },
  {
    date: 'Q2 2018',
    title: 'Fund and name management',
    description: "Get the ability to access a subset of user funds and domain names. Send cryptocurrency from one address to another, transfer domain names, update domain name information, and more."
  },
  {
    date: 'Q3 2018',
    title: 'Federated Simple Contracts',
    description: "Imagine smart contracts but none of the code runs on the chain. A federation of VM's runs the contract and settles monetary transactions on chain with multi-signature accounts. Do everything you can do with smart contracts in a more secure and scalable way."
  },
]
