...
export const installationLinks = {
  ...
  portalDevelopersMacOS: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.21.0/Blockstack-for-macOS-v0.21.0.dmg',
  portalDevelopersWindows: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.21.0/Blockstack-for-win10-v0.21.0.msi',
  portalDevelopersLinux: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.21.0/Blockstack-for-Linux-v0.21.0.sh',
