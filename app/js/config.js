...
export const installationLinks = {
  ...
  portalDevelopersWindows: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.20.1/Blockstack-for-win10-v0.20.1.msi',
  portalDevelopersLinux: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.20.1/Blockstack-for-Linux-v0.20.1.sh',
