...
export const installationLinks = {
  ...
  portalDevelopersMacOS: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.23.0/Blockstack-for-macOS-v0.23.0.dmg',
  portalDevelopersWindows: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.23.0/Blockstack-for-win10-v0.23.0.msi',
  portalDevelopersLinux: 'https://github.com/blockstack/blockstack-browser/releases/download/v0.23.0/Blockstack-for-Linux-v0.23.0.sh',
...
export const teamMembers = [
  ...
  },
  {
    ...
    bio: 'Aaron joined the Blockstack engineering team from an academic background, finishing his PhD in 2017. His doctoral research spanned a range of topics, mostly focusing on web application performance and security. He’s worked in information flow tracking systems, caching algorithms, compilers, and applied cryptography. 10+ years of Emacs usage.',
  },
  {
    blockstackId: 'larry',
    name: 'Larry Salibra',
  ...
  },
  {
    blockstackId: '',
    name: 'Shannon Voight',
    avatar: '/images/avatars/shannon-voight.jpg',
  ...
  },
  {
    ...
    name: 'JP Singh, Technical Advisor',
