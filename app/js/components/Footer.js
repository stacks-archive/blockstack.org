          ...
          <div className="row">
            ...
            <div className="container foot-3col">
              <div className="row">
                ...
                <div className="col-6 col-md-3">
                  <div className="foot-menu">
                    <div className="foot-item text-white">Community</div>
                    <div className="foot-item">
                      <Link to={links.forum} target="_blank">
                        Forum
                      </Link>
                    </div>
                    <div className="foot-item">
                      <Link to={links.slack} target="_blank">
                        Slack
                      </Link>
                    </div>
                    <div className="foot-item">
                ...
                <div className="col-6 col-md-3">
                  <div className="foot-menu">
                    <div className="foot-item text-white">Resources</div>
                    <div className="foot-item">
                    ...
                    <div className="foot-item">
                      <Link to={links.branding} target="_blank">
                        Branding
                      </Link>
                    </div>
                    <div className="foot-item">
              ...
              <div className="row">
                <div className="col-12 col-md-3 order-md-2 mt-5 foot-social">
                  <div className="container d-flex justify-content-md-end">
                    ...
                    <div className="d-inline">
                      <Link to={links.youtube} target="_blank">
                        <i className="fa fa-youtube-play foot-social-item" />
                      </Link>
                    </div>
                    <div className="d-inline">
                      <Link to={links.github} target="_blank">
                        <i className="fa fa-github foot-social-item" />
                      </Link>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-md-9 order-md-1 mt-2 mt-md-5">
                  <div className="container">
                    <div className="foot-text">
                      This is an open sourced site hosted on GitHub. Patches,
                ...
                <div className="col-12 col-md-9 order-md-1 mt-1 mt-md-3">
                  <div className="container">
                    ...
                    >
                      The Blockstack Tokens are a crypto asset that is currently
                      being developed by Blockstack Token LLC, a Delaware
                      limited liability company, whose website can be found at
                      www.blockstack.com. The website you are currently visiting
                      (www.blockstack.org) is sponsored by Blockstack PBC, an
                      affiliate of Blockstack Token LLC, and should not be
                      viewed as an offer or sale of securities.
                    </div>
                  </div>
                </div>
              </div>
