            ...
            <div className="post-content m-t-3">
              ...
              <div className="col-sm-12 col-md-8 col-centered m-b-100" style={{ textAlign: 'center' }} >
                ...
                <p className="font-weight-bold" >
                  ...
                  Galen Wolfe-Pauly, <span className="font-weight-normal font-italic">Urbit Founder< br/></span>
                  Moderated by Dan Elitzer, <span className="font-weight-normal font-italic">IDEO coLAB Blockchain & Digital Identity Lead</span>
                </p>
              </div>
              ...
              <div className="col-sm-12 col-md-8 col-centered m-b-100" style={{ textAlign: 'center' }} >
                ...
                <p className="font-weight-bold" >
                  ...
                  Melanie Shapiro, <span className="font-weight-normal font-italic">Tokenzie CEO< br/></span>
                  Ryan Shea, <span className="font-weight-normal font-italic">Blockstack Co-founder< br/></span>
                  Moderated by Dan Elitzer, <span className="font-weight-normal font-italic">IDEO coLAB Blockchain & Digital Identity Lead</span>
                </p>
              </div>
              ...
              <div className="col-sm-12 col-md-8 col-centered m-b-100" style={{ textAlign: 'center' }} >
                ...
                <p className="font-weight-bold" >
                  ...
                  Balaji Srinivasan, <span className="font-weight-normal font-italic">Andreessen Horowitz Board Partner and 21 CEO< br/></span>
                  Moderated by Tuur Demeester, <span className="font-weight-normal font-italic">Adamant Research, Economic & Investor, Editor in Chief</span>
                </p>
              </div>
              ...
              <div className="col-sm-12 col-md-8 col-centered m-b-100" style={{ textAlign: 'center' }} >
                ...
                <p className="font-weight-bold" >
                  ...
                  Naval Ravikant, <span className="font-weight-normal font-italic">AngelList Founder< br/></span>
                  Garry Tan, <span className="font-weight-normal font-italic">Initialized Capital Managing Partner< br/></span>
                  Moderated by Brian Lio, <span className="font-weight-normal font-italic">Smith + Crown CEO</span>
                </p>
              </div>
