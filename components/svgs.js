...
const LogoWhite = () => (
  <svg width="35.409px" height="36px" viewBox="0 0 35.409 36">
    <path
      d="M35.409,24.647c0,0,0.008,3.752-0.393,5.378c-0.402,1.626-1.14,2.76-1.957,3.592
...
const LogoType = () => (
  <svg
    style={{ width: '141.602', height: '11.487px' }}
    viewBox="0 0 141.602 11.487"
    enableBackground="new 0 0 141.602 11.487"
  >
    <path
      fill="#FFFFFF"
      d="M5.471,7.791c0,0.511-0.16,0.875-0.488,1.111C4.631,9.158,4.097,9.287,3.398,9.287H2.387V6.456h1.011
